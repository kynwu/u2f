...
type VirtualKey struct {
	...
	// One to Many relationship, meaning a dongle can be applied to mutiple service
	keys []keyInst
}
...
func generateCert(privateKey *ecdsa.PrivateKey) []byte {
	...
	// self-signed certificate. because parent is equal to template
...
func (vk *VirtualKey) HandleRegisterRequest(req WebRegisterRequest) (*RegisterResponse, error) {
...
func (vk *VirtualKey) HandleAuthenticationRequest(req WebSignRequest) (*SignResponse, error) {
